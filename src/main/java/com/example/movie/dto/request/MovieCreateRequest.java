...
public class MovieCreateRequest {
    ...
    public MovieCreateServiceRequest toServiceRequest() {
        return MovieCreateServiceRequest.builder()
                .title(title)
                .rating(rating)
    ...
    public static class ScreeningRequest {
        ...
        public MovieCreateServiceRequest.ScreeningServiceCreateRequest toServiceRequest() {
            return MovieCreateServiceRequest.ScreeningServiceCreateRequest.builder()
                    .date(date)
                    .startedAt(startedAt)
                    .endedAt(endedAt)
                    .theaterId(theaterId)
